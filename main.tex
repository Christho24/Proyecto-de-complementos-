...
\begin{itemize}
    \item \textbf{Dirección de Vinculación con el Medio:} Son los que pidieron el proyecto. A ellos les interesa ordenar la información y mejorar la cantidad de alumnos que logran conseguir trabajo.
    \item \textbf{Autoridades de la Universidad Finis Terrae:} Buscan modernizar cómo se hacen las cosas hoy en día en la universidad y mejorar la imagen, conectando mejor a los alumnos con las empresas.
    \item \textbf{Sector Productivo:} El mercado laboral y las empresas de afuera, que salen ganando al tener un lugar centralizado donde encontrar alumnos capacitados y listos para trabajar.
    \item \textbf{Equipo de Desarrollo:} Nosotros, los que estamos creando la plataforma. Tenemos que asegurar que el sistema funcione bien, que el módulo recomiende de verdad a los alumnos y entregar el software a tiempo.
\end{itemize}
...
\textbf{Estudiantes y Egresados} & Los que buscan práctica o trabajo. Van a entrar para armar su Currículum Vitae Virtual (CVV), poner cuánto quieren ganar y postular a lo que les sirva. \\ \hline
\textbf{Empresas Externas} & Los que ofrecen el trabajo. Una vez que los validemos, van a poder publicar sus avisos con todos los detalles y revisar a los alumnos que postulen. \\ \hline
\textbf{Áreas Internas UFT} & Son departamentos de la misma universidad que funcionan igual que una empresa externa, ofreciendo prácticas o pegas adentro de la Finis. \\ \hline
\textbf{Administradores} & Los que controlan todo. Tienen que revisar si las empresas que se registran son de verdad, ver que las ofertas estén bien y manejar el tema de las recomendaciones. \\ \hline
\textbf{Visitantes} & Cualquier persona que entre a la página sin hacerse una cuenta. Solo van a poder mirar y filtrar las ofertas laborales que estén públicas, sin poder postular a nada. \\ \hline
\end{tabular}
\end{table}
